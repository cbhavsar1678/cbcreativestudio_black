  ...
  return (
    <div className="flex flex-col md:flex-row min-h-[calc(100vh-160px)]">
      ...
      <section className="md:w-3/5 p-16 flex flex-col justify-center border-r border-gold/10">
        ...
        >
          <div className="mb-4">
            <span className="text-gold font-serif italic text-lg opacity-80">EST. 2009</span>
          </div>
          <h1 className="font-serif text-7xl md:text-8xl leading-[0.9] mb-8 text-white uppercase">
            Crafting <br />
            <span className="italic font-light">Digital</span> <br />
            Legacies.
          </h1>
          <p className="max-w-md text-text-muted text-sm leading-relaxed mb-10">
            A bespoke design studio dedicated to high-end product leadership and strategic brand evolution for visionaries.
          </p>
          <div className="flex gap-6">
            <Link to="/inquiry" className="px-8 py-3 bg-gold text-bg-deep text-[10px] uppercase tracking-[0.2em] font-bold hover:brightness-110 transition-all text-center">
              Start Project
            </Link>
            <Link to="/portfolio" className="px-8 py-3 border border-gold/50 text-[10px] uppercase tracking-[0.2em] font-bold hover:bg-gold/5 transition-all text-center">
              View Work
            </Link>
          </div>
        </motion.div>
      ...
      <section className="md:w-2/5 flex flex-col bg-bg-deep">
        <div className="p-12 border-b border-gold/10 h-1/2 flex flex-col justify-center">
          <h3 className="text-[10px] uppercase tracking-[0.3em] text-gold mb-8">Signature Work</h3>
            ...
            {signatureWork.map((work, idx) => (
              ...
              >
                <div className="flex justify-between items-end mb-2">
                  <h4 className="font-serif text-2xl group-hover:text-gold transition-colors">{work.title}</h4>
                  <span className="text-[9px] opacity-40 uppercase tracking-widest">{work.year}</span>
                </div>
